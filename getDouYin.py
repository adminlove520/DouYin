...
后续会继续加入 抖音去水印 自动发布抖音和其他平台的自动化，自动筛选视频功能
'''
...
#公众号urls
#公众号文章链接
urls=["https://mp.weixin.qq.com/s/AXwmMNbP_JJ7GUOZbd0RNA"]
...
def publish_shipinhao(path_mp4):
    ...
    #视频描述
    describe=mp4_file_name.replace(".mp4",'@叫我典狱长大人').replace("DOU","").replace("抖音","")
